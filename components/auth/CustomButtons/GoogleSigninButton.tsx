...
export default function GoogleSigninButton({ text, onClick }: ButtonProps) {
  return (
    <button
      className="flex w-[70vw] sm:w-[60vw] md:w-100 m-auto items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray-2 p-[15px] font-medium hover:bg-opacity-50 dark:border-dark-3 dark:bg-dark-2 dark:hover:bg-opacity-50"
     onClick={onClick}
    >
      <span>
        <svg
