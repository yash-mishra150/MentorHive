...
const config: Config = {
  ...
  theme: {
    fontFamily: {
      ...
      signature: ["var(--font-whispering-signature)", "sans-serif"],
    },
    screens: {
      "2xsm": "375px",
      xsm: "425px",
    ...
    extend: {
      ...
      keyframes: {
        softGlow: {
          "0%, 100%": { textShadow: "0 0 6px rgba(255, 255, 255, 0.5)" },
          "50%": { textShadow: "0 0 12px rgba(255, 255, 255, 0.9)" },
        },
        linspin: {
      ...
      animation: {
        softGlow: "softGlow 2s infinite ease-in-out",
